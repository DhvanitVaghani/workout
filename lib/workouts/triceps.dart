...
class _Triceps extends State<Triceps> {
  ...
  List<String> images = [
    'images/triceps/11.jpg',
    'images/triceps/12.jpg',
    'images/triceps/13.jpg',
    'images/triceps/14.jpg',
    'images/triceps/15.jpg',
    'images/triceps/16.jpg'
  ];
  @override
          ...
          return <Widget>[
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                title: Text("Triceps Workout"),
                background:
                    new Image.asset("images/triback.jpg", fit: BoxFit.cover),
              ),
            ),
          ];
        },
